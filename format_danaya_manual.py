...
# Create the JSON request manually
json_request = '''{"spreadsheetId":"1ySI_0RG9HIZKIdNCtfqW_gZ_U0VGIxAGkog9Nhnt2Y0","requests":[
  {
    "setDataValidation": {
      "range": {
        "sheetId": 412743935,
...
# Write to a file
with open('/tmp/format_request.json', 'w') as f:
